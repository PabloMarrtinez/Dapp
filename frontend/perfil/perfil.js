...
const addressContractERC20 = '0x096959acCA0B79802bE52cE8F38A0832D2C5C0a0';
...
function contract() {
  ...
  proxyContract = new web3.eth.Contract(abiERC20,addressContractERC20);
  interact();
}

function interact(){ 
  const address = document.querySelector('.direccion');
  proxyContract.methods.balanceOf(address.value).call().then(res => {
